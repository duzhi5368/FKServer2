...
BOOL WebPlayer::ConnectWebServer( )
{
	...
	_MY_TRY
	{
		...
		Log::SaveLog( BILLING_LOGFILE, "连接Web服务器 IP:%s Port:%d 成功",
	...
	Log::SaveLog( BILLING_LOGFILE, "连接Web服务器： 当前ServerID:%d 完成", 
...
EXCEPTION:
	...
	Log::SaveLog( BILLING_LOGFILE, "错误： 连接Web服务器 - WebIP:%s WebPort:%d WebServerID:%d 失败",
	...
	Log::SaveLog( BILLING_LOGFILE, "异常: ConnectWebServer") ;
